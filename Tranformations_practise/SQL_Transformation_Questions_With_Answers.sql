/* ============================================================================
   ...
   Scope     SQL Transformations only (cleaning, conditional, string, date,
             numeric, aggregate/conditional aggregation, window functions,
             ranking/dedup, running totals, pivot, JSON, array-like).
   Layout    Each block = question (comment) + runnable solution query.
